...
import org.noxfire.edt.MainWindow;
...
public class JEditTextArea extends JComponent
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5504352551729889867L;
	/**
	...
	{
		this(TextAreaDefaults.getDefaults(), null);
	}

	/**
	 * Added by Olaf Neumann on 2008-08-22 because for Copy-And-Paste-functionality we need a
	 * reference to the main window which handels the copy-and-paste things
	 * 
	 * @param owner
	 *            the frame, where the editor is used
	 */
	public JEditTextArea(MainWindow owner)
	{
		this(TextAreaDefaults.getDefaults(), owner);
	}
	 ...
	 * @param owner
	 *            added by Olaf Neumann on 2008-08-22 for copy-and-paste-stuff
	 */
	public JEditTextArea(TextAreaDefaults defaults, MainWindow owner)
	{
		this.owner = owner;
	...
	public void processKeyEvent(KeyEvent evt)
	{
		...
		switch (evt.getID())
		{
			...
			case KeyEvent.KEY_PRESSED:
				...
				if ((evt.getKeyCode() == KeyEvent.VK_C || evt.getKeyCode() == KeyEvent.VK_V || evt.getKeyCode() == KeyEvent.VK_X)
				...
				{
					owner.fireRunButtonAction(this);
				}
				else if (evt.getKeyCode() == KeyEvent.VK_F9)
				{
					owner.openExternalEditorWindow();
				}
	...
	class MouseHandler extends MouseAdapter
	{
		...
		private void doDoubleClick(MouseEvent evt, int line, int offset, int dot) throws BadLocationException
		{
			 ...
			 * getLineStartOffset(line); select(lineStart + wordStart,lineStart + wordEnd);
			 */
		}
