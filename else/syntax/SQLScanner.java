...
import org.noxfire.edt.jedit.Token;
...
public class SQLScanner extends Scanner
{
    ...
    {
    	lookup(KEYWORD, "ADD");
    	lookup(KEYWORD, "ALTER");
    	lookup(KEYWORD, "ANSI_NULLS");
    	lookup(KEYWORD, "AS");
    	lookup(KEYWORD, "ASC");
    	lookup(KEYWORD, "AUTHORIZATION");
    	lookup(KEYWORD, "BACKUP");
    	lookup(KEYWORD, "BEGIN");
    	lookup(KEYWORD, "BREAK");
    	lookup(KEYWORD, "BROWSE");
    	lookup(KEYWORD, "BULK");
    	lookup(KEYWORD, "BY");
    	lookup(KEYWORD, "CASCADE");
    	lookup(KEYWORD, "CHECK");
    	lookup(KEYWORD, "CHECKPOINT");
    	lookup(KEYWORD, "CLOSE");
    	lookup(KEYWORD, "CLUSTERED");
    	lookup(KEYWORD, "COLUMN");
    	lookup(KEYWORD, "COMMIT");
    	lookup(KEYWORD, "COMMITTED");
    	lookup(KEYWORD, "COMPUTE");
    	lookup(KEYWORD, "CONFIRM");
    	lookup(KEYWORD, "CONSTRAINT");
    	lookup(KEYWORD, "CONTAINS");
    	lookup(KEYWORD, "CONTAINSTABLE");
    	lookup(KEYWORD, "CONTINUE");
    	lookup(KEYWORD, "CONTROLROW");
    	lookup(KEYWORD, "CREATE");
    	lookup(KEYWORD, "CURRENT");
    	lookup(KEYWORD, "CURRENT_DATE");
    	lookup(KEYWORD, "CURRENT_TIME");
    	lookup(KEYWORD, "CURSOR");
    	lookup(KEYWORD, "DATABASE");
    	lookup(KEYWORD, "DBCC");
    	lookup(KEYWORD, "DEALLOCATE");
    	lookup(KEYWORD, "DECLARE");
    	lookup(KEYWORD, "DELETE");
    	lookup(KEYWORD, "DENY");
    	lookup(KEYWORD, "DESC");
    	lookup(KEYWORD, "DISK");
    	lookup(KEYWORD, "DISTINCT");
    	lookup(KEYWORD, "DISTRIBUTED");
    ...
    private void initKind()
    {
        ...
        for (char c = 0; c < 128; c++)
            if (kind[c] == -1)
                System.out.println(
                    "Char " + ((int) c) + " hasn't been classified");
    }
